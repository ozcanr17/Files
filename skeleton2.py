...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.device1.setGeometry(QtCore.QRect(50, 40, 151, 21))
        font = QtGui.QFont()
        ...
        self.device2.setGeometry(QtCore.QRect(50, 80, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.device3.setGeometry(QtCore.QRect(50, 120, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.device4.setGeometry(QtCore.QRect(50, 160, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.device5.setGeometry(QtCore.QRect(50, 200, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.device9.setGeometry(QtCore.QRect(350, 120, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.device8.setGeometry(QtCore.QRect(350, 80, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.device2.setText(_translate("MainWindow", "Television"))
        self.device3.setText(_translate("MainWindow", "Dishwasher Machine"))
        self.device4.setText(_translate("MainWindow", "Washing Machine"))
        self.device5.setText(_translate("MainWindow", "Vacuum Cleaner"))
        self.device6.setText(_translate("MainWindow", "Hair Dryer"))  
        self.device7.setText(_translate("MainWindow", "Oven"))
        self.device8.setText(_translate("MainWindow", "Micrawave Oven"))
        self.device9.setText(_translate("MainWindow", "Iron"))
        self.device10.setText(_translate("MainWindow", "Air Conditioner"))
        self.device11.setText(_translate("MainWindow", "Kettle"))
        self.device12.setText(_translate("MainWindow", "Toast Machine"))
